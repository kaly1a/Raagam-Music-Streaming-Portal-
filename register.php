		...
		<div id="loginContainer">
			...
			<div id="inputContainer">
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="lastName" name="lastName" type="text" placeholder="Your Lastname" value="<?php getInputValue('lastName') ?>" required>
					</p>
			...
			<div id="loginText">
				...
				<ul>
					...
					<li>Find your favourite artists!</li>
				</ul>
			</div>
